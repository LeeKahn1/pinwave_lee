...
<head>
    ...
    <title>Account Management - Pinwave</title>
                            ...
                            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                                ...
                                <div class="sm:col-span-9">
                                    <div class="flex items-center gap-5">
                                        @if (Auth::user()->profile_photo_path)
                                            <img src="{{ Storage::url(Auth::user()->profile_photo_path) }}"
                                                alt="{{ Auth::user()->name }}"
                                                class="inline-block size-16 rounded-full ring-2 ring-white">
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{ Auth::user()->username }}&background=DBEAFE&color=1E40AF&bold=true"
                                                alt="{{ Auth::user()->name }}"
                                                class="inline-block size-16 rounded-full ring-2 ring-white">
                                ...
                                <div class="sm:col-span-9">
                                    <input id="username" type="text"
                                        ...
                                        placeholder="Update your username" name="username"
                                        value="{{ $user->username }}">
                                </div>
                                <!-- End Col -->
                                ...
                                <div class="sm:col-span-9">
                                    <input id="email" type="email"
                                        class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        placeholder="Update your email" name="email" value="{{ $user->email }}">
                                </div>
                                <!-- End Col -->
                            ...
                            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                                ...
                                <div class="sm:col-span-9">
                                    <div class="">
                                        ...
                                        <input type="password"
                                            class="mt-4 py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                            placeholder="Enter new password" name="password">
                                        <input type="password"
                                            class="mt-2 py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
