                            ...
                            <div class="mt-24 gap-4 w-60">
                                ...
                                <div>
                                    <h2 class="text-center text-black text-base font-semibold leading-relaxed pb-1">
                                        Hasil pencarian kami tidak ada</h2>
                                    <p class="text-center text-black text-sm font-normal leading-snug pb-4">Coba cari
                                        dengan kata kunci <br />yang lain ya! </p>
