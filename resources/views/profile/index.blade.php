...
<head>
    ...
    <title>{{ $user->username }} - Pinwave Profile</title>
    ...
    <main id="content">
        <div class="w-full mx-auto bg-[#F9FAFB] min-h-screen">
            ...
            <div class="mx-auto px-4 py-4">
                <div class="mx-auto">
                    <!-- Card -->
                    <div class="bg-white rounded-xl shadow mx-auto">
                        <div class="px-4 py-4">
                            <!-- Grid -->
                            <div>
                                ...
                                <div class="flex justify-center">
                                    ...
                                    <div class="grid sm:flex sm:items-center sm:gap-x-5">
                                        ...
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{ $user->username }}&background=DBEAFE&color=1E40AF&bold=true"
                                                alt="{{ $user->username }}"
                                                class="-mt-8 relative z-10 inline-block size-24 mx-auto sm:mx-0 rounded-full ring-4 ring-white">
                                        @endif
                                    </div>
                                ...
                                <div class="mt-4 flex flex-col items-center">
                                    <h4 class="text-black text-xl font-bold">{{ $user->username }}</h4>
                                    <p class="text-gray-500 text-base font-normal">{{ $user->email }}</p>
                                </div>
                                <div class="mt-8 mb-3 flex justify-center gap-4 md:!gap-14">
                                    <div class="flex flex-col items-center justify-center">
                                        <h3 class="text-black text-2xl font-bold"></h3>
                                        <h3 class="text-black text-2xl font-bold">{{ count($pins) }}</h3>
                                        <p class="text-gray-400 text-sm font-normal">Pins</p>
                                    </div>
                                    <div class="flex flex-col items-center justify-center">
                                        <h3 class="text-black text-2xl font-bold">{{ $likesCount }}</h3>
                                        <p class="text-gray-400 text-sm font-normal">Likes</p>
                                    </div>
                                    <div class="flex flex-col items-center justify-center">
                                        <h3 class="text-black text-2xl font-bold">{{ $followersCount }}</h3>
                                        <p class="text-gray-400 text-sm font-normal">Followers</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="mx-auto px-4 pb-4">
                <div class="bg-white rounded-xl shadow mx-auto px-4 py-4">
                                        ...
                                        <div class="w-full flex flex-wrap justify-center gap-10">
                                            <div class="mt-24 gap-4 w-60">
                                                <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg"
                                                    width="128" height="124" viewBox="0 0 128 124"
                                                    fill="none">
                                                    ...
                                                    <defs>
                                                        <filter id="filter0_d_14133_718" x="2" y="0" width="124"
                                                            height="124" filterUnits="userSpaceOnUse"
                                                ...
                                                <div>
                                                    ...
                                                    <p
                                                        class="text-center text-black text-sm font-normal leading-snug pb-4">
                                                        Coba cari
                    ...
                    <div id="horizontal-alignment-2" class="hidden" role="tabpanel"
                        ...
                        <div class="mx-auto px-4 py-4">
                            <button type="button"
                                class="py-3 px-4 my-8 mr-auto inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-blue-500 bg-white text-blue-500  disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div
                                        ...
                                        <form method="POST" action="{{ route('albums.store') }}">
                                            ...
                                            <div class="p-4 overflow-y-auto">
                                                <label for="input-label" class="block text-sm font-medium mb-2">Album
                                                    name</label>
                                                <input type="text" id="input-label"
                                                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 "
                                                    placeholder="Enter album name .." name="name" autofocus="">
                                            </div>
                                    ...
                                    <a class="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-xl p-5 "
                                        ...
                                        <div class="aspect-w-16 aspect-h-11">
                                            <img class="w-full object-cover rounded-xl"
                                                src="{{ asset('storage/pins/' . $album->cover_image_url) }}"
                                                alt="Image Description">
                                        </div>
                                        <div class="my-6">
                                        ...
                                        <div class="mt-auto flex items-center gap-x-3">
                                            ...
                                            @if ($user->profile_photo_path)
                                                <img src="{{ Storage::url($user->profile_photo_path) }}"
                                                    alt="{{ $user->username }}" class="size-8 rounded-full">
                                            @else
                                                <img src="https://ui-avatars.com/api/?name={{ $user->username }}&background=DBEAFE&color=1E40AF&bold=true"
                                                    alt="{{ $user->username }}" class="size-8 rounded-full">
                                            @endif
                                            <div>
                                                <h5 class="text-sm text-gray-800">By {{ $user->username }}</h5>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- End Card -->
